...
My biggest takeaway from this is understanding that fixed elements don't take up any space in the document. So once we fixed the nav in place, there was a little big of a 'janky' reflow effect where the next element took up that space that had been occupied by the nav. To counteract this, we needed to add padding in the amount of pixels that had been taken up by the nav to the body of the document. 